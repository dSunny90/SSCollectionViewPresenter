...
final class SectionInfoTests: XCTestCase {
    ...
    func test_section_info_grid_column_count() {
        // Given
        var section = SSCollectionViewModel.SectionInfo()
        XCTAssertNil(section.gridColumnCount)

        // When
        section.gridColumnCount = 2

        // Then
        XCTAssertEqual(section.gridColumnCount, 2)
    }

    func test_section_info_grid_column_count_zero() {
        // Given
        var section = SSCollectionViewModel.SectionInfo()

        // When
        section.gridColumnCount = 0

        // Then
        XCTAssertEqual(section.gridColumnCount, 0)
    }
