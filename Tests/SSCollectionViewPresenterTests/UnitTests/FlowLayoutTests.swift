...
final class FlowLayoutTests: XCTestCase {
    ...
    func test_size_for_item_with_nil_view_model_returns_flow_layout_default() throws {
        // Given
        let cv = makeCollectionView()
        let flowLayout = try XCTUnwrap(cv.collectionViewLayout as? UICollectionViewFlowLayout)
    ...
    func test_inset_for_section_with_nil_view_model_returns_flow_layout_default() throws {
        // Given
        let cv = makeCollectionView()
        let flowLayout = try XCTUnwrap(cv.collectionViewLayout as? UICollectionViewFlowLayout)
    ...
    func test_minimum_line_spacing_with_nil_view_model_returns_flow_layout_default() throws {
        // Given
        let cv = makeCollectionView()
        let flowLayout = try XCTUnwrap(cv.collectionViewLayout as? UICollectionViewFlowLayout)
    ...
    func test_header_size_with_nil_view_model_returns_flow_layout_default() throws {
        // Given
        let cv = makeCollectionView()
        let flowLayout = try XCTUnwrap(cv.collectionViewLayout as? UICollectionViewFlowLayout)
    ...
    func test_section_insets_nil_falls_back_to_flow_layout_default() throws {
        // Given
        let cv = makeCollectionView()
