...
//
//  Created by SunSoo Jeon on 2021/07/04.
//
...
public struct SSCompositionalLayoutSection {
    ...
    public struct OrthogonalScrollingProperties {
        /// Deceleration rate value for orthogonal scrolling.
        public var decelerationRateValue: CGFloat = 0.998
        ...
        ///
        /// - Parameters:
        ///   - decelerationRateValue: Deceleration rate. Defaults to `0.998`.
        ///   - bounce: Bounce behavior. Defaults to `.automatic`.
        public init(
            decelerationRateValue: CGFloat = 0.998,
            bounce: Bounce = .automatic
        ) {
            self.decelerationRateValue = decelerationRateValue
            self.bounce = bounce
        }
    }
