...
Cells can conform to `EventSendingProvider` to expose interactions like `touchUpInside`, `valueChanged`, or gesture recognizers.
...
```swift
dependencies: [
    .package(url: "https://github.com/dSunny90/SSCollectionViewPresenter", from: "0.1.0")
]
```
